...
- **Authentification** : Système Django intégré avec sessions
- **Autorisation** : Mixins de contrôle d'accès par rôle (`AdminRequiredMixin`, etc.)
- **CSRF** : Protection activée sur tous les formulaires
- **Validation** : Validation côté serveur et client
- **Mots de passe** : Politique de complexité Django standard
- **XSS** : Protection par échappement automatique
